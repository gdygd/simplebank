...
// Source: github.com/gdygd/simplebank/db/sqlc (interfaces: Store)
...
// ListEntrie mocks base method.
func (m *MockStore) ListEntrie(arg0 context.Context, arg1 db.ListEntrieParams) ([]db.Entry, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListEntrie", arg0, arg1)
	ret0, _ := ret[0].([]db.Entry)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListEntrie indicates an expected call of ListEntrie.
func (mr *MockStoreMockRecorder) ListEntrie(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListEntrie", reflect.TypeOf((*MockStore)(nil).ListEntrie), arg0, arg1)
}
